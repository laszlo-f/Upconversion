...
float amotry(double **p, double y[], double psum[], int ndim,
...
void linmin(double p[], double xi[], int n, double *fret,
	double (*func)(double [])); /*altered to double TWS*/
...
//float select(unsigned long k, unsigned long n, float arr[]);//conflicts with standard library
...
void score();
void scrsho();
//float select();//conflicts with standard library
float selip();
void shell();
void shoot();
void shootf();
